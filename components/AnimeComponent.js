...
import { StyleSheet, FlatList, ScrollView, View, Text, ActivityIndicator, ImageBackground, Modal, TouchableOpacity, TouchableWithoutFeedback, Linking, Dimensions, InteractionManager } from 'react-native';
            ...
            renderItem={({ item, index }) => {
                    ...
                    return (
                        <TouchableOpacity
                            ...
                            style={{ flex: 1 }}
                        >
                            <Animated.View style={{ opacity, marginHorizontal: 4, paddingHorizontal: 12, paddingVertical: 2, backgroundColor: `rgba(255,255,255,0.8)`, borderRadius: 20 }}>
...
class Anime extends React.PureComponent {
    ...
    componentDidMount() {
        InteractionManager.runAfterInteractions(() => {
            console.log('Interaction anime done')
        })
        setTimeout(()=>{
                ...
                <LinearGradient style={{flex: 1}} colors={['rgba(0,0,0,0.1)'].concat(this.props.theme[this.props.theme.current].anime.linear_background)}>
                    ...
                    <Tab.Navigator backBehavior="none" lazy tabBar={props => <MyTabBar {...props} />} >
                        ...
                        <Tab.Screen name='pictures' options={{ title: 'PICTURES' }}>
                            {() => <Picture id={this.props.route.params.id} navigation={this.props.navigation} />}
                        </Tab.Screen>
