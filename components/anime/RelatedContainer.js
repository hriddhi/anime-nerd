                            ...
                            if(this.props.related[this.props.id].related.length === 0){
                                return (
                                    <View style={{ flex: 1, justifyContent: 'center', alignSelf: 'center' }}>
                                        ...
                                        <Text style={{ fontFamily: 'SpaceGrotesk-SemiBold', color: this.props.theme[this.props.theme.current].anime.text, fontSize: 16, paddingVertical: 16, alignSelf: 'center' }}>No Related Animes found</Text>
                                    </View>
                                )
                            }
                            return (
