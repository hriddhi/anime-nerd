                ...
                <FlatList data={this.props.reviews.reviews} 
                    ...
                    renderItem={({ item, index }) => (
                        <TouchableOpacity key={index} activeOpacity={0.7} onPress={() => this.expandReview(index) }>
                            <View key={index} style={{ flex: 1, padding: 0, marginVertical: 4, marginHorizontal: 8, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.8)' }}>
                                <View style={{ flex: 1, paddingVertical: 2, paddingHorizontal: 4, flexDirection: 'row', flexWrap: 'wrap', backgroundColor: 'rgba(0,0,0,0.2)' }}>
                                    <Text style={{ flex: 1, flexGrow: 1, fontSize: 10, fontFamily: 'SpaceGrotesk-SemiBold', marginVertical: 2, paddingVertical: 2, textAlign: 'center' }}>ANIMATION {item.reviewer.scores.animation}</Text>
                                    <Text style={{ flex: 1, flexGrow: 1, fontSize: 10, fontFamily: 'SpaceGrotesk-SemiBold', marginVertical: 2, paddingVertical: 2, textAlign: 'center' }}>STORY {item.reviewer.scores.story}</Text>
                                    <Text style={{ flex: 1, flexGrow: 1, fontSize: 10, fontFamily: 'SpaceGrotesk-SemiBold', marginVertical: 2, paddingVertical: 2, textAlign: 'center' }}>CHARACTER {item.reviewer.scores.character}</Text>
                                    <Text style={{ flex: 1, flexGrow: 1, fontSize: 10, fontFamily: 'SpaceGrotesk-SemiBold', marginVertical: 2, paddingVertical: 2, textAlign: 'center' }}>SOUND {item.reviewer.scores.sound}</Text>
                                    <Text style={{ flex: 1, flexGrow: 1, fontSize: 10, fontFamily: 'SpaceGrotesk-SemiBold', marginVertical: 2, paddingVertical: 2, textAlign: 'center' }}>ENJOYED {item.reviewer.scores.enjoyment}</Text>
                                </View>
                                <View style={{ flex: 1, flexDirection: 'row' }}>
                                    <View style={{ flex: 1, flexGrow: 1, backgroundColor: 'rgba(0,0,0,0.3)', alignItems: 'center', paddingVertical: 8 }}>
                                        <Text style={{ fontSize: 22, fontFamily: 'SpaceGrotesk-SemiBold' }}>{item.reviewer.scores.overall}</Text>
                                    </View>
